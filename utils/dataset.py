"""Text / image-prompt datasets used by TetherCache inference scripts.

Copied from Self-Forcing (Apache 2.0). The training-only LMDB datasets
(``ODERegressionLMDBDataset``, ``ShardingLMDBDataset``) are dropped — they
...
class TextImagePairDataset(Dataset):
    """Image-conditioned (I2V) inference dataset."""
    ...
    def __init__(
        ...
        # target_crop_info_<aspect>.json -> <aspect>
